...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add("text-style");
    editInput.classList.add("list-style");
    ...
    deleteButtonImg.classList.add("list-image");
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.text-style');
